...
╚══════════════════════════════════════════════════════════════╝
    ...
    console.log(
      chalk.green(
        '🎉 Welcome to LoanTrack Pro - Your World-Class Loan Management Toolkit!'
      )
    );
    console.log(
      chalk.gray(
        '   Built specifically for Termux with professional-grade features'
      )
    );
    console.log();
  ...
  async shutdown(): Promise<void> {
    try {
      ...
      console.log(
        chalk.gray('   Created with ❤️  by John Ilesanmi (@numcalm)')
      );
      console.log();
